# AGENTS.md — arakelov-rh-descent

## Role: RH-CLUSTER / DESCENT

**Cluster:** Riemann Hypothesis

**Core claim:** Arakelov-geometric descent argument — positivity forces ζ zeros to critical line
...
Look for the main `.lean` file at repo root or `RH/` subdirectory.

## Siblings in this cluster

| Repo | Role |
|------|------|
| [DavidFox998/rh-p5-bridge-14](https://github.com/DavidFox998/rh-p5-bridge-14) | sibling in cluster |
