...
Three lines of formal proof; no step is vacuous. No `fun _ => trivial`.
...
Gate M3 feeds two named open surfaces into the closed descent theorem `grh_descent_to_RH`. The combinator is:
